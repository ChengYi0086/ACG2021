from Chance_sampled_CFR import Memoryless_base
...
num_of_train_iterations = 1
num_of_big_iterations = 2
# total training iterations = big iterations * train iterations
num_of_test_games = 1000

# Random vs Heuristic
game1 = Memoryless_base.Cheat_w_hpt(3,2,2,["Random player","Heuristic player"],4,["Save_for_paper/Data","Memoryless_4"])
...
game3 = Memoryless_base.Cheat_w_hpt(3,2,2,["Random player","CFR player"],4,["Save_for_paper/Data","Memoryless_4"])
    # Heuristic vs CFR
game4 = Memoryless_base.Cheat_w_hpt(3,2,2,["Heuristic player","CFR player"],4,["Save_for_paper/Data","Memoryless_4"])
...
for _ in range(num_of_big_iterations):
    ...
    # CFR training
    game2 = Memoryless_base.Cheat_w_hpt(3,2,2,["CFR player 1","CFR player 2"],4,["Save_for_paper/Data","Memoryless_4"])

    # ----------- Training Part ----------- 
    CFR_trainer = Memoryless_base.Cheat_w_hpt_Trainer(game2,"Save_for_paper/Data","Memoryless_4")
...
plt.title('Time Cost')
#plt.yscale('log')
plt.savefig("Save_for_paper/Figures/Memoryless_4_100iter_Training_time")
plt.show()
...
plt.savefig("Save_for_paper/Figures/Memoryless_4_100iter_Number_of_infosets")
plt.show()
...
plt.legend(loc = 0)
plt.savefig("Save_for_paper/Figures/Memoryless_4_100iter_Winning_rates")
plt.show()
