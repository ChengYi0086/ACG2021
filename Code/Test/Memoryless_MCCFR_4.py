...
# Random vs Heuristic
game1 = Cheat_w_hpt(3,2,2,["Random player","Heuristic player"],4,["Save_for_paper/Data","M_MCCFR_4"])
...
game3 = Cheat_w_hpt(3,2,2,["Random player","CFR player"],4,["Save_for_paper/Data","M_MCCFR_4"])
    # Heuristic vs CFR
...
for _ in range(num_of_big_iterations):
    ...
    # CFR training
    game2 = Cheat_w_hpt(3,2,2,["CFR player 1","CFR player 2"],4,["Save_for_paper/Data","M_MCCFR_4"])

    # ----------- Training Part ----------- 
    CFR_trainer = Cheat_w_hpt_Trainer(game2,"Save_for_paper/Data","M_MCCFR_4")
...
plt.title('Time Cost')
#plt.yscale('log')
plt.savefig("Save_for_paper/Figures/M_MCCFR_4_10w_iter_Training_time")
plt.show()
...
plt.savefig("Save_for_paper/Figures/M_MCCFR_4_10w_iter_Number_of_infosets")
plt.show()
...
plt.legend(loc = 0)
plt.savefig("Save_for_paper/Figures/M_MCCFR_4_10w_iter_Winning_rates")
plt.show()
